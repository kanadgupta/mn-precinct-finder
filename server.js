...
fastify.register(require("fastify-swagger"), {
  openapi: {
    info: {
      ...
      description:
        "An API for retrieving MN Precinct Data and Minneapolis 2021 Polling Places.",
      version: "1.0.0",
    },
    servers: [
      {
...
async function createDefaultParams(request, reply) {
  ...
  if (request.query.address) {
    try {
      ...
      error.message = 'There was an error looking up your address! Please contact the developer.';
    ...
    response: {
      200: {
        ...
        properties: {
          address: {
            description:
              "A formatted address (formatted by the Google Geocoding API) based on the request parameters",
            example: "2506 Central Ave NE, Minneapolis, MN 55418",
            type: "string",
          },
          gmaps: {
            description:
              "A link to Google Maps for the street address in the `address` parameter.",
            example:
              "https://www.google.com/maps/search/?api=1&query=2506+Central+Ave+NE%2C+Minneapolis%2C+MN+55418",
            type: "string",
          },
          mplsPollingPlace21: {
            description:
          ...
          precinct: {
            ...
            properties: {
              ...
              CtyComDist: {
                description: "County Commissioner District",
                example: "2",
                type: "string",
              },
              Hospital: {
                description: "Hospital District ID",
                example: "no data",
                type: "string",
              },
              Judicial: {
              ...
              MCDCode: {
                description: "Minor Civil Division Code",
                example: "135",
                type: "string",
              },
              MCDName: {
                description: "Minor Civil Division Name",
                example: "Minneapolis",
                type: "string",
              },
              MNLegDist: {
                description: "Minnesota House District",
                example: "60A",
                type: "string",
              },
              MNSenDist: {
                description: "Minnesota Senate District",
                example: "60",
                type: "string",
              },
              Park: {
              ...
              Precinct: {
                description: "Precinct Name",
                example: "Minneapolis W-1 P-9",
                type: "string",
              },
              PrecinctCode: {
                description:
                  "Precinct Code — this is specific to each County (see `PrecinctID`)",
                example: "1400",
                type: "string",
              },
              PrecinctID: {
              ...
              SoilAndWater: {
                description: "Soil And Water District ID",
                example: "no data",
                type: "string",
              },
              Ward: {
